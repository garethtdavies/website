...
With slot duration of 3 mins and assuming 90% honest stake, the following table shows the finality in blocks and time and the confidence that payment will be confirmed.

|Finality (in blocks) | Finality (in minutes) | Finality confidence |
|-------------------|---------------------|---------------------|
| 8| 24 mins | 98.6709|
|15| 45 mins|99.9231|
| 23| 69 mins |99.9965|
...
TODO: Calculate finality minutes based on average number of blocks when f = 0.75
