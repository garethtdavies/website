...
If you are running the node on a cloud virtual machine, you will need to copy the contents of the peer list at https://storage.googleapis.com/mina-seed-lists/mainnet_seeds.txt into a new local file at `~/peers.txt`
...
For testing purposes, you should create a seperate account that you can send a transaction to. For this example we will use the following example public key as the recipient:
...
- The `receiver` is the public key of the example account
